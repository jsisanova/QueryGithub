 ...
 */
package com.example.android.querygithub;
...
import com.example.android.querygithub.utilities.NetworkUtils;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize the loader with LoaderManager - with GITHUB_SEARCH_LOADER as the ID, null for the bundle, and this for the callback
    ...
    private void makeGithubSearchQuery() {
        ...
        // If no search was entered, but the search button was clicked, indicate that there isn't anything to search for and return. We will not attempt to load anything.
         /*
        ...
        // Create a bundle called queryBundle (that we will pass to our Loader)
